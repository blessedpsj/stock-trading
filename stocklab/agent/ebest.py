...
class EBest:
    ...
    def get_code_list(self, market=None):
        ...
        result = self._execute_query("t8436", "t8436InBlock", "t8436OutBlock1", *out_params, **in_params)
        return result
    ...
    def get_stock_price_by_code(self,code=None, cnt="1"):
        ...
        out_params = ['date', 'open', 'high', 'low', 'close', 'sign',
                        ...
                        'l_diff', 'marketcap']
        result = self._execute_query("t1305", "t1305InBlock", "t1305OutBlock", *out_params, **in_params)

        [dict(item, **{'code':code}) for item in result] # 파이썬스러운 딕셔너리 병합(merge) 방법
