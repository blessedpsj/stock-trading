"""
xml 파일에서 추출한 값들(ex_shrs, apliDt 등)에 대한 정보는
한국예탁결제원 기업정보서비스 기술문서(hwp)에서 확인 가능.
"""
...
class Data():
    ...
    def get_corp_code(self, name=None):
        ...
        :param result:dict 회사 코드와 회사명을 반환합니다.
        """
        ...
        res = requests.get(request_url[:-1]) # 마지막 "&" 삭제하고 get으로 불러옴. 반환값을 res에 저장.
